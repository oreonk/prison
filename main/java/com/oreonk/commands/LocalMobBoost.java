...
public class LocalMobBoost implements CommandExecutor {
    @Override
        ...
        if (arguments.length != 3) {
            ...
            if (NumberUtils.isNumber(arguments[1]) && NumberUtils.isNumber(arguments[2])) {
                if (Bukkit.getPlayer(arguments[0]).isOnline()){
                    ...
                    if (!Prison.getInstance().privateMobBooster.containsKey(uuid) && !Prison.getInstance().privateMobMultiplier.containsKey(uuid)) {
                        if (Integer.parseInt(arguments[2])<1 || Integer.parseInt(arguments[2])>2){
                            ...
                            Prison.getInstance().privateMobBooster.put(uuid, Integer.parseInt(arguments[1]));
                            Prison.getInstance().privateMobMultiplier.put(uuid, Integer.parseInt(arguments[2]));
                            return true;
                        }
                } else {
                        if (Integer.parseInt(arguments[2])<1 || Integer.parseInt(arguments[2])>2){
                            ...
                            Prison.getInstance().privateMobBooster.replace(uuid, Integer.parseInt(arguments[1]));
                            Prison.getInstance().privateMobMultiplier.replace(uuid, Integer.parseInt(arguments[2]));
                            return true;
                        }
                }
                } else {
