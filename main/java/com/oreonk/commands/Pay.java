            ...
            if (NumberUtils.isNumber(arguments[1])) {
                if (Integer.parseInt(arguments[1]) < 1) {
                    ...
                    if (Bukkit.getPlayer(arguments[0]) != null) {
                        ...
                        Msg.send(player, ChatColor.GREEN + "Вы перечислили " + stringFinalAmount + "  игроку " + onlinePlayer.getName());
                        ...
                        economy.withdrawPlayer(player, Double.parseDouble(stringFinalAmount));
                        Msg.send(player, ChatColor.GREEN + "Вы перечислили " + stringFinalAmount + "  игроку " + offlinePlayer.getName());
